...
class Introduction(Page):
    ...
    def vars_for_template(self):
        ...
        return dict(
            game_name=game_name,
            image_path='img_for_players/2x2/1_introduction/{}.jpg'.format(self.round_number),
            pdf_path='pdf_for_players/2x2/1_introduction/{}.pdf'.format(self.round_number),
...
class Decision(Page):
    ...
    def vars_for_template(self):
        ...
        return dict(
            image_path='img_for_players/2x2/2_decision/{}.jpg'.format(self.round_number),
            chat1=chat1
        )
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        return {
            ...
            'image_path':'img_for_players/2x2/3_interm_results/{}.jpg'.format(self.round_number)
        }
